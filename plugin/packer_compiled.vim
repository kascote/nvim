...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lua", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip" },
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "playground", "nvim-ts-context-commentstring", "nvim-ts-autotag" },
    only_config = true
  },
