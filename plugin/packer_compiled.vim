...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua" },
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-refactor", "nvim-ts-context-commentstring", "nvim-ts-autotag" },
    only_config = true
  },
