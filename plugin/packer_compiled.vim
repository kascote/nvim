...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "vim-vsnip", "cmp-vsnip", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "vim-vsnip-integ" },
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-treesitter-refactor", "nvim-ts-context-commentstring", "playground" },
    only_config = true
  },
