...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp_luasnip" },
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-treesitter-refactor", "playground", "nvim-ts-context-commentstring" },
    only_config = true
  },
