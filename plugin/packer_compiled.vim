...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-path" },
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-treesitter-refactor", "nvim-ts-autotag", "nvim-ts-context-commentstring" },
    only_config = true
  },
