...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "playground", "nvim-ts-autotag", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
