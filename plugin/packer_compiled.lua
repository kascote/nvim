...
_G.packer_plugins = {
  ...
  ["lf.nvim"] = {
    config = { "\27LJ\2\nb\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\16escape_quit\1\18focus_on_open\1\vborder\frounded\nsetup\alf\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-nvim-lua" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-autotag", "nvim-ts-context-commentstring", "nvim-treesitter-refactor" },
    loaded = true,
    only_config = true
  },
