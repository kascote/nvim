...
_G.packer_plugins = {
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/Users/nelson/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
