...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-ts-context-commentstring", "nvim-treesitter-refactor", "nvim-ts-autotag" },
    loaded = true,
    only_config = true
  },
