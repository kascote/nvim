...
function M.setup(colors, config)
  ...
  -- Vim editor colors
  hi.ColorColumn = { guifg = nil, guibg = M.colors.base02, gui = "none", guisp = nil }
  hi.Conceal = { guifg = M.colors.blue, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.CurSearch = { guifg = M.colors.base00, guibg = M.colors.base0A, gui = nil, guisp = nil }
  hi.Cursor = { guifg = M.colors.base00, guibg = M.colors.base05, gui = nil, guisp = nil }
  -- lCursor
  -- CursorIM
  hi.CursorColumn = { guifg = nil, guibg = M.colors.base02, gui = "none", guisp = nil }
  ...
  -- TermCursor
  -- TermCursorNC
  hi.ErrorMsg = { guifg = M.colors.red, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.WinSeparator = { guifg = M.colors.base02, guibg = M.colors.base00, gui = "none", guisp = nil }
  hi.Folded = { guifg = M.colors.cyan, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.FoldColumn = { guifg = M.colors.cyan, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.SignColumn = { guifg = M.colors.base04, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.IncSearch = { guifg = M.colors.base01, guibg = M.colors.orange, gui = "none", guisp = nil }
  hi.Substitute = { guifg = M.colors.base0A, guibg = M.colors.orange, gui = "none", guisp = nil }
  hi.LineNr = { guifg = M.colors.base03, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.LineNrAbove = { guifg = M.colors.base03, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.LineNrBelow = { guifg = M.colors.base03, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.CursorLineNr = { guifg = M.colors.base07, guibg = M.colors.base02, gui = nil, guisp = nil }
  -- CursorLineFold
  -- CursorLineSign
  hi.MatchParen = { guifg = M.colors.base00, guibg = M.colors.base0A, gui = nil, guisp = nil }
  ...
  -- PmenuSbar
  -- PmenuThumb
  hi.Question = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.QuickFixLine = { guifg = nil, guibg = M.colors.base01, gui = "none", guisp = nil }
  hi.Search = { guifg = M.colors.base0A, guibg = M.colors.base03, gui = nil, guisp = nil }
  ...
  hi.TabLineSel = { guifg = M.colors.green, guibg = M.colors.base01, gui = "none", guisp = nil }
  hi.Title = { guifg = M.colors.base09, guibg = nil, gui = "none", guisp = nil }
  hi.Visual = { guifg = nil, guibg = M.colors.base02, gui = nil, guisp = nil }
  hi.VisualNOS = { guifg = M.colors.red, guibg = nil, gui = nil, guisp = nil }
  hi.WarningMsg = { guifg = M.colors.red, guibg = nil, gui = nil, guisp = nil }
  -- WhiteSpace
  hi.WildMenu = { guifg = M.colors.red, guibg = M.colors.yellow, gui = nil, guisp = nil }
  hi.WinBar = { guifg = M.colors.base05, guibg = M.colors.base11, gui = "none", guisp = nil }
  ...
  hi.SpellBad = { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.red }
  hi.SpellCap = { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.blue }
  hi.SpellLocal = { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.cyan }
  hi.SpellRare = { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.magenta }

  -- Standard syntax highlighting
  hi.Boolean = { guifg = M.colors.base09, guibg = nil, gui = nil, guisp = nil }
  hi.Character = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Comment = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
  hi.Conditional = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Constant = { guifg = M.colors.primary, guibg = nil, gui = nil, guisp = nil }
  ...
  hi.Include = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Keyword = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Label = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Macro = { guifg = M.colors.red, guibg = nil, gui = nil, guisp = nil }
  ...
  hi.PreProc = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Repeat = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Special = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.SpecialChar = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Statement = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.StorageClass = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.String = { guifg = M.colors.primary, guibg = nil, gui = nil, guisp = nil }
  hi.Structure = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.Tag = { guifg = M.colors.base04, guibg = nil, gui = nil, guisp = nil }
  hi.Todo = { guifg = M.colors.base05, guibg = M.colors.base01, gui = nil, guisp = nil }
  ...
  hi.DiffText = { guifg = M.colors.blue, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.DiffAdded = { guifg = M.colors.green, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.DiffFile = { guifg = M.colors.red, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.DiffNewFile = { guifg = M.colors.green, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.DiffLine = { guifg = M.colors.blue, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.DiffRemoved = { guifg = M.colors.red, guibg = M.colors.base00, gui = nil, guisp = nil }

  -- Git highlighting
  hi.gitcommitOverflow = { guifg = M.colors.red, guibg = nil, gui = nil, guisp = nil }
  hi.gitcommitSummary = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  ...
  hi.gitcommitHeader = { guifg = M.colors.magenta, guibg = nil, gui = nil, guisp = nil }
  hi.gitcommitSelectedType = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
  hi.gitcommitUnmergedType = { guifg = M.colors.blue, guibg = nil, gui = nil, guisp = nil }
  hi.gitcommitDiscardedType = { guifg = M.colors.red, guibg = nil, gui = nil, guisp = nil }
  hi.gitcommitBranch = { guifg = M.colors.orange, guibg = nil, gui = "bold", guisp = nil }
  hi.gitcommitUntrackedFile = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
  hi.gitcommitUnmergedFile = { guifg = M.colors.base03, guibg = nil, gui = "bold", guisp = nil }
  hi.gitcommitDiscardedFile = { guifg = M.colors.base03, guibg = nil, gui = "bold", guisp = nil }
  hi.gitcommitSelectedFile = { guifg = M.colors.base03, guibg = nil, gui = "bold", guisp = nil }

  -- GitGutter highlighting
  hi.GitGutterAdd = { guifg = M.colors.green, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.GitGutterChange = { guifg = M.colors.yellow, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.GitGutterDelete = { guifg = M.colors.red, guibg = M.colors.base00, gui = nil, guisp = nil }
  hi.GitGutterChangeDelete = { guifg = M.colors.magenta, guibg = M.colors.base00, gui = nil, guisp = nil }
  ...
  hi.DiagnosticInfo = { guifg = M.colors.blue, guibg = nil, gui = "none", guisp = nil }
  hi.DiagnosticHint = { guifg = M.colors.cyan, guibg = nil, gui = "none", guisp = nil }
  hi.DiagnosticOk = { guifg = M.colors.green, guibg = nil, gui = "none", guisp = nil }
  ...
  hi.DiagnosticUnderlineOk = "DiagnosticOk"
  ...
  hi.DiagnosticSignOk = "DiagnosticOk"

  hi.LspReferenceText = { guifg = M.colors.cyan, guibg = nil, gui = "underline", guisp = M.colors.blue }
  hi.LspReferenceRead = { guifg = M.colors.yellow, guibg = nil, gui = "underline", guisp = M.colors.yellow }
  hi.LspReferenceWrite = { guifg = M.colors.red, guibg = nil, gui = "underline", guisp = M.colors.magenta }
  ...
  hi.LspCodeLens = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
  hi.LspCodeLensSeparator = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil }
  hi.LspSignatureActiveParameter = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
  ...
  hi.TSConstBuiltin = { guifg = M.colors.base05, guibg = nil, gui = "italic", guisp = nil }
  hi.TSConstMacro = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSError = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSException = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSField = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSFloat = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSFunction = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSFuncBuiltin = { guifg = M.colors.base05, guibg = nil, gui = "italic", guisp = nil }
  hi.TSFuncMacro = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSInclude = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSKeyword = { guifg = M.colors.base03, guibg = nil, gui = "none", guisp = nil }
  hi.TSKeywordFunction = { guifg = M.colors.base03, guibg = nil, gui = "none", guisp = nil }
  hi.TSKeywordOperator = { guifg = M.colors.base03, guibg = nil, gui = "none", guisp = nil }
  hi.TSLabel = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSMethod = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSNamespace = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  ...
  hi.TSPunctSpecial = { guifg = M.colors.magenta, guibg = nil, gui = "none", guisp = nil }
  hi.TSRepeat = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSString = { guifg = M.colors.primary, guibg = nil, gui = "none", guisp = nil }
  ...
  hi.TSSymbol = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSTag = { guifg = M.colors.base04, guibg = nil, gui = "none", guisp = nil }
  hi.TSTagDelimiter = { guifg = M.colors.base04, guibg = nil, gui = "none", guisp = nil }
  hi.TSText = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
  hi.TSStrong = { guifg = nil, guibg = nil, gui = "bold", guisp = nil }
  hi.TSEmphasis = { guifg = M.colors.base05, guibg = nil, gui = "italic", guisp = nil }
  ...
  hi.TSVariableBuiltin = { guifg = M.colors.base06, guibg = nil, gui = "italic", guisp = nil }
  ...
  if vim.fn.has "nvim-0.8.0" then
    ...
    hi["@punctuation"] = "TSPunctDelimiter"
  ...
  if M.config.ts_rainbow then
    ...
    hi.rainbowcol7 = { guifg = M.colors.magenta }
  end
  ...
  hi.User1 = { guifg = M.colors.red, guibg = M.colors.base02, gui = "none", guisp = nil }
  hi.User2 = { guifg = M.colors.magenta, guibg = M.colors.base02, gui = "none", guisp = nil }
  hi.User3 = { guifg = M.colors.base05, guibg = M.colors.base02, gui = "none", guisp = nil }
  hi.User4 = { guifg = M.colors.cyan, guibg = M.colors.base02, gui = "none", guisp = nil }
  ...
  if M.config.telescope then
    ...
    hi.TelescopePromptTitle = { guifg = M.colors.base09, guibg = M.colors.darkerstatusline, gui = nil, guisp = nil }
    ...
    hi.TelescopePreviewLine = { guifg = M.colors.base09, guibg = M.colors.primary, gui = "none", guisp = nil }
  end

  if M.config.notify then
    hi.NotifyERRORBorder = { guifg = M.colors.red, guibg = nil, gui = "none", guisp = nil }
    hi.NotifyWARNBorder = { guifg = M.colors.magenta, guibg = nil, gui = "none", guisp = nil }
    ...
    hi.NotifyWARNIcon = { guifg = M.colors.magenta, guibg = nil, gui = "none", guisp = nil }
    ...
    hi.NotifyWARNTitle = { guifg = M.colors.magenta, guibg = nil, gui = "none", guisp = nil }
  ...
  if M.config.cmp then
    ...
    hi.CmpItemAbbr = { guifg = M.colors.base04, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemAbbrDeprecated = { guifg = M.colors.base02, guibg = nil, gui = "strikethrough", guisp = nil }
    hi.CmpItemAbbrMatch = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemAbbrMatchFuzzy = { guifg = M.colors.base01, guibg = nil, gui = nil, guisp = nil }
    ...
    hi.CmpItemKindKeyword = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindVariable = { guifg = M.colors.base06, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindConstant = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindReference = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindValue = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindFunction = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindMethod = { guifg = M.colors.base04, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindConstructor = { guifg = M.colors.base06, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindClass = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindInterface = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindStruct = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindEvent = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindEnum = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindUnit = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindModule = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindProperty = { guifg = M.colors.base04, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindField = { guifg = M.colors.base06, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindTypeParameter = { guifg = M.colors.base04, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindEnumMember = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindOperator = { guifg = M.colors.base05, guibg = nil, gui = nil, guisp = nil }
    hi.CmpItemKindSnippet = { guifg = M.colors.base07, guibg = nil, gui = nil, guisp = nil }
  end
  ...
  vim.g.terminal_color_13 = M.colors.magenta
