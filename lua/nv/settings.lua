...
vim.opt_global.wildignore     = vim.opt_global.wildignore + '*/vendor/gems/*,*/vendor/cache/*,*/.bundle/*,*/.sass-cache/*'
-- set wildignore+=*/tmp/*
...
vim.opt_global.shortmess      = vim.opt_global.shortmess + 'a'      -- use abbreviations in messages eg. `[RO]` instead of `[readonly]`
...
vim.opt.listchars             = { tab = '▷┅', trail = '•', extends = '…', precedes = '…', eol = '↲', nbsp = '⦸' } -- " what to show when I hit :set list
