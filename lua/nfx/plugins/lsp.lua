...
vim.cmd('hi! link LspDiagnosticsErrorSign LspDiagnosticsDefaultError')
vim.cmd('hi! link LspDiagnosticsWarningSign LspDiagnosticsDefaultWarning')
vim.cmd('hi! link LspDiagnosticsInformationSign LspDiagnosticsDefaultInformation')
vim.cmd('hi! link LspDiagnosticsHintSign LspDiagnosticsDefaultHint')
...
vim.cmd('hi! link LspDiagnosticsErrorFloating LspDiagnosticsDefaultError')
vim.cmd('hi! link LspDiagnosticsWarningFloating LspDiagnosticsDefaultWarning')
vim.cmd('hi! link LspDiagnosticsInformationFloating LspDiagnosticsDefaultInformation')
vim.cmd('hi! link LspDiagnosticsHintFloating LspDiagnosticsDefaultHint')
